<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuspiciousActivity.aspx.cs" Inherits="CrimeMap.SuspiciousActivity" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Report Suspisious Activity</h3>
    <div class="row">
        <div class="col-md-4">
            <div class="form" style="" role="form">
        <fieldset>
            <div class="form-group">
                <label for="c_category">Activity type</label>
                <select class="form-control" runat="server" id="c_category">
                    <option value="1">Bribery</option>
                    <option value="2">Drug Dealers</option>
                    <option value="3">Terrorisms</option>
                    <option value="4">Gambling</option>
                 
                </select>
            </div>
            <div class="form-group">
                <label for="c_detail">Activity Detail</label>
            ...
            <div class="form-group">
                <asp:Button Text="Submit" CssClass="btn btn-primary form-control" runat="server" ID="ReportSubmit"  />
            </div>
            <div />
